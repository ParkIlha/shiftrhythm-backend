...
public record ParseScheduleResponse(List<ShiftTypeDef> shiftTypes, List<ShiftDay> shifts) {
     ...
     *
     * @param mapped DAY | EVENING | NIGHT | OFF — ai-server가 반드시 넷 중 하나로 골라서 준다
     */
    public record ShiftTypeDef(String shiftType, String mapped, String startTime, String endTime) {
    }
